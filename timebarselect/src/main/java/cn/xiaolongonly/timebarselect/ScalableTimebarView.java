...
public class ScalableTimebarView extends View {
     ...
     */
    private final int KEY_TICK_TEXT_SIZE_IN_SP = 13;
     ...
     */
    private final int IND_TRIANGLE_BOTTOM_LINE_IN_DP = 9;

    /**
     * Line Length of Triangle
     */
    private final int IND_TRIANGLE_HEIGHT_IN_DP = 6;
     ...
     */
    private int BIG_TICK_HALF_WIDTH = DeviceUtil.dip2px(BIG_TICK_HALF_WIDTH_IN_DP);
    private int BIG_TICK_HEIGHT = DeviceUtil.dip2px(BIG_TICK_HEIGHT_IN_DP);
    private int IND_TRIANGLE_BOTTOM_LINE_LENGTH = DeviceUtil.dip2px(IND_TRIANGLE_BOTTOM_LINE_IN_DP);
    private int IND_TRIANGLE_HEIGHT = DeviceUtil.dip2px(IND_TRIANGLE_HEIGHT_IN_DP);
    private int IND_LINE_WIDTH = DeviceUtil.dip2px(IND_LINE_WIDTH_IN_DP);
    private int SMALL_TICK_HALF_WIDTH = DeviceUtil.dip2px(SMALL_TICK_HALF_WIDTH_IN_DP);
    private int SMALL_TICK_HEIGHT = DeviceUtil.dip2px(SMALL_TICK_HEIGHT_IN_DP);
    private int KEY_TICK_TEXT_SIZE = DeviceUtil.dip2px(KEY_TICK_TEXT_SIZE_IN_SP);
    private int TICK_TEXT_TO_TICK_MARGIN = DeviceUtil.dip2px(TICK_TEXT_TO_TICK_MARGIN_IN_DP);
    private int VIEW_HEIGHT = DeviceUtil.dip2px(VIEW_HEIGHT_IN_DP);
    private int COLORED_RECORDBAR_TO_TICK_TEXT_MARGIN = DeviceUtil.dip2px(COLORED_RECORDBAR_TO_TICK_TEXT_MARGIN_IN_DP);
    private int COLORED_RECORDBAR_HEIGHT = DeviceUtil.dip2px(COLORED_RECORDBAR_HEIGHT_IN_DP);
